 ...
 * Excludes past topics to prevent repetition.
 */
...
/**
 * Generates a script for AI videos. Uses generateChainReactionScript internally.
 */
 ...
 * Uses the "Sync-First" strategy: Generate Audio -> Get Timestamps -> Generate Scene Descriptions.
 */
